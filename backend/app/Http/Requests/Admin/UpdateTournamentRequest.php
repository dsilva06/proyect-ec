...
class UpdateTournamentRequest extends FormRequest
{
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            $startDate = $this->input('start_date') ?? $tournament?->start_date?->toDateString();
            $openAt = $this->input('registration_open_at') ?? $tournament?->registration_open_at;
            $closeAt = $this->input('registration_close_at') ?? $tournament?->registration_close_at;
