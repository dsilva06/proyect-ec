...
class TeamService
{
    ...
    private function createSuccessfulPayment(
        ...
        return Payment::query()->create([
            ...
            'amount_cents' => max(0, (int) ($category?->entry_fee_amount ?? $category?->tournament?->entry_fee_amount ?? 0)) * 100,
            'currency' => strtoupper((string) ($category?->currency ?: $category?->tournament?->entry_fee_currency ?: 'EUR')),
