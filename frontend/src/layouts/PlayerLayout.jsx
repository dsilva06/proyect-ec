...
const PLAYER_HUB_ITEMS = PLAYER_MENU_ITEMS.filter((item) => item.to !== '/player/profile')
  ...
  return (
    <div className="admin-shell admin-shell-pro admin-shell-player">
      ...
      <section className="admin-main">
        ...
        <nav className="player-quick-strip" aria-label="Accesos rápidos del torneo">
          {PLAYER_HUB_ITEMS.map((item) => (
